...
export const members = [
  ...
  createMember({
    ...
    brief_intro: `I'm pursuing my Bachelor's degree at Concordia University (until tentatively 2024).
        
        By trade, I specialize in DevSecOps, SDLC, full-stack web development, distributed systems, and IT generalist.

        All the while, I am actively developing and exploring database, virtualization/containerization, and micro-service solutions and researching SotA themes in ML/AI. As an avid adopter of cloud, server, and networking technologies, I experiment with a homelab cluster.
            `,
